...
from lagou.tools.selenium_spider import login_lagou
class CookieMiddleware(object):

    def __init__(self):
        self.cookie = login_lagou()
...
class ProxyMiddleWare(object):
    def get_random_proxy(self):
        while True:
            with open("C:\\Users\\王煜\\Desktop\\ok_ip.txt", 'r') as f:
                proxys = f.readlines()
            if proxys:
                break
            else:
